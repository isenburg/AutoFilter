            ...
            VStack(alignment: .leading, spacing: 16) {
                ...
                VStack(alignment: .leading, spacing: 8) {
                    ...
                    VStack(alignment: .leading, spacing: 6) {
                        ...
                        bullet(isDe ? "Direkte Sprachumschaltung: Die überflüssige Option 'System' wurde entfernt; die Spracheinstellung erfolgt nun über ein direktes Segmented Control für Deutsch (🇩🇪) und Englisch (🇬🇧)." : "Direct Language Switching: Removed the redundant 'System' option; language selection now uses an instant segmented control for German (🇩🇪) and English (🇬🇧).", font: .subheadline, color: .secondary)
                        bullet(isDe ? "Ausbreitungskarte feste Seitenleiste & Mindestgröße: Feste 240 pt Breite für die rechte Länderleiste und Mindestfenstergröße von 840 × 380 pt, damit Karten-Overlays und QSO-Banner stets optimal lesbar bleiben." : "Propagation Map Fixed Sidebar & Min Size: Fixed 240 pt width for the right sidebar and an 840 × 380 pt minimum window size to ensure overlays and QSO banners remain perfectly readable.", font: .subheadline, color: .secondary)
                    }
                    .font(.subheadline)
                    .foregroundStyle(.secondary)
                }
